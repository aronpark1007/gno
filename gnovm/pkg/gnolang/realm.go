...
var (
	pkgIDFromPkgPathCacheMu sync.Mutex // protects both caches.
...
// PkgPathFromPkgID returns the package path for the given PkgID.
// Returns empty string if the PkgID has not been seen yet.
